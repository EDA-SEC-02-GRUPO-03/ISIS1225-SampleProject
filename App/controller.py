...
def loadBooks(catalog, booksfile):
    ...
    input_file = csv.DictReader(open(booksfile, encoding='utf8'))
...
def loadTags(catalog, tagsfile):
    ...
    input_file = csv.DictReader(open(tagsfile, encoding='utf8'))
...
def loadBooksTags(catalog, booktagsfile):
    ...
    input_file = csv.DictReader(open(booktagsfile, encoding='utf8'))
    for tag in input_file:
